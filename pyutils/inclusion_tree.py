...
# This script is borrowed from the IMC paper source code (https://github.com/sajjadium/DeepCrawling/blob/master/inclusion_tree.py)
# Modified to suit my log
...
def get_inclusion_tree(raw_logs):
    ...
    for entry in data:
        ...
        try:
            ...
            print >> sys.stderr, traceback.format_exc(), data['url'], event
